/**
 * SettingsPanel.jsx - Carrier selection settings modal
...
export default function SettingsPanel({ isOpen, onClose }) {
  const [enabledCarriers, setLocalEnabledCarriers] = useState(getEnabledCarriers());
              ...
              >
                ...
                <div className="carrier-info">
                  ...
                  <div className="carrier-plans">
                    {(info.plans || []).map(plan => (
                      <span key={plan} className="plan-badge">{plan}</span>
                    ))}
                  </div>
                </div>
