...
const AREA_CODE_TO_STATE = {
  ...
  '407': 'Florida', '561': 'Florida', '727': 'Florida', '754': 'Florida', '772': 'Florida',
  '786': 'Florida', '813': 'Florida', '850': 'Florida', '863': 'Florida', '904': 'Florida',
  ...
  '586': 'Michigan', '616': 'Michigan', '734': 'Michigan', '810': 'Michigan', '906': 'Michigan', '947': 'Michigan', '989': 'Michigan',
  // Minnesota
  ...
  '603': 'New Hampshire',
  // New Jersey
  '201': 'New Jersey', '551': 'New Jersey', '609': 'New Jersey', '732': 'New Jersey', '848': 'New Jersey',
  ...
  '828': 'North Carolina', '910': 'North Carolina', '919': 'North Carolina', '980': 'North Carolina', '984': 'North Carolina',
  // North Dakota
  '701': 'North Dakota',
  // Ohio
  '216': 'Ohio', '220': 'Ohio', '234': 'Ohio', '283': 'Ohio', '330': 'Ohio', '380': 'Ohio',
  '419': 'Ohio', '440': 'Ohio', '513': 'Ohio', '567': 'Ohio', '614': 'Ohio', '740': 'Ohio', '937': 'Ohio',
  // Oklahoma
  ...
  '445': 'Pennsylvania', '484': 'Pennsylvania', '570': 'Pennsylvania', '582': 'Pennsylvania', '610': 'Pennsylvania',
  '717': 'Pennsylvania', '724': 'Pennsylvania', '814': 'Pennsylvania', '835': 'Pennsylvania', '878': 'Pennsylvania',
  // Rhode Island
  '401': 'Rhode Island',
  // South Carolina
  ...
  // Wisconsin
  '262': 'Wisconsin', '274': 'Wisconsin', '414': 'Wisconsin', '534': 'Wisconsin', '608': 'Wisconsin', '715': 'Wisconsin', '920': 'Wisconsin',
  // Wyoming
  '307': 'Wyoming',
  // Washington DC
  '202': 'Washington D.C.'
 ...
 */
export const extractAreaCode = (phoneNumber) => {
 ...
 */
export const getStateFromAreaCode = (phoneNumber) => {
 ...
 * @returns {string[]} - Array of area codes
 */
export const getAreaCodesForState = (stateName) => {
